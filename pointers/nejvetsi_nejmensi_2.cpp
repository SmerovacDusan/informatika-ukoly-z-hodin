...
int main() {
    ...
    if (p_nejmensi_prvek != nullptr && p_nejvetsi_prvek != nullptr) {
        cout << "Nejmensi hodnota: " << *p_nejmensi_prvek << " (nalezena na adrese: " << p_nejmensi_prvek << ")" << endl;
        
        cout << "Nejvetsi hodnota: " << *p_nejvetsi_prvek << " (nalezena na adrese: " << p_nejvetsi_prvek << ")" << endl;
    } else {
        cout << "Pole bylo prazdne, min/max nebylo nalezeno." << endl;
    }
